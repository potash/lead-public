...
insert into wic.wic_kid_edges (wic_id, kid_id) (
...
select w1.wic_id id1, w2.wic_id id2, initials from wic.wic_kid_edges w1 join wic.wic_kid_edges w2 using (kid_id) join aux.kids_initial ki on kid_id = ki.id where w1.wic_id != w2.wic_id
