...
create table buildings.original_buildings as (
    select coalesce(nullif(orig_bldg_, 0), nextval('original_building_id')) as orig_bldg_, orig_bldg_ as orig_bldg_2,
        f_add1,t_add1, pre_dir1, st_name1, st_type1, edit_date,
