...
SELECT array_agg(test_id) as test_ids, null as cornerstone_ids, first_name, last_name, date_of_birth::text, 
...
SELECT null, array_agg(distinct part_id_i), 
    brth_fst_t, brth_lst_t, birth_d::text, addr_ln1_t, count(*) as count
from 
infants join
